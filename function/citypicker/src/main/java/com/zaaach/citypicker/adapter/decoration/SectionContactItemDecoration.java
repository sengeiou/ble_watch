...
public class SectionContactItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public SectionContactItemDecoration(Context context, List<ContactModel> data) {
        this.mData = data;

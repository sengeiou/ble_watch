...
public class SportHeartLevelView extends View {
    ...
    private int[] datas;
    public SportHeartLevelView(Context context) {
        super(context);
        initView();
    }

    public SportHeartLevelView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public SportHeartLevelView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {

...
import static com.szip.blewatch.base.Const.RouterPathConst.PATH_ACTIVITY_REPORT_TEMP;
import static com.szip.blewatch.base.Const.RouterPathConst.PATH_ACTIVITY_USER_FAQ;

@Route(path = PATH_ACTIVITY_REPORT_TEMP)
public class TempReportActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadDataUtil.newInstance().initCalendarPoint("temp");
        initView();
        initPage();
    }

    private void initView() {
        setTitle(getString(R.string.healthy_temp));

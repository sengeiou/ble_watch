...
public class BloodOxygenMonthPresenterImpl implements IBloodOxygenPresenter{

    private Context mContext;
    private IBloodOxygenView iBloodOxygenView;

    public BloodOxygenMonthPresenterImpl(Context mContext, IBloodOxygenView iBloodOxygenView) {

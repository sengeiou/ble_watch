...
import static com.szip.blewatch.base.Const.RouterPathConst.PATH_ACTIVITY_REPORT_SPO2;
import static com.szip.blewatch.base.Const.RouterPathConst.PATH_ACTIVITY_USER_FAQ;

@Route(path = PATH_ACTIVITY_REPORT_SPO2)
public class BloodOxygenReportActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadDataUtil.newInstance().initCalendarPoint("bo");
        initView();
        initPage();
    }

    private void initView() {
        setTitle(getString(R.string.healthy_blood_oxygen));
    ...
    private void initPage() {
        ...
        // 创建一个集合,装填Fragment
        BloodOxygenFragment dayFragment =  new BloodOxygenFragment(ReportConst.REPORT_DAY);
        BloodOxygenFragment weekFragment =  new BloodOxygenFragment(ReportConst.REPORT_WEEK);
        BloodOxygenFragment monthFragment =  new BloodOxygenFragment(ReportConst.REPORT_MONTH);
        // 装填
